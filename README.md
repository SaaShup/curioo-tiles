...
<p align="center">
  ...
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#04315b"/>
      <stop offset="100%" stop-color="#0979e6"/>
    </linearGradient>
  </defs>

  <rect x="2" y="2" width="416" height="92" rx="18" fill="url(#bg)"/>

  <g transform="translate(12,8) scale(0.14)">
  ...
  <text x="105" y="36"
        ...
        font-size="14"
        fill="white"
        opacity="0.85">Deploy with</text>

  <text x="105" y="66"
        font-family="Arial, Helvetica, sans-serif"
        font-size="30"
        font-weight="700"
        fill="white">SaaShup</text>
</svg>
  </a>
</p>
